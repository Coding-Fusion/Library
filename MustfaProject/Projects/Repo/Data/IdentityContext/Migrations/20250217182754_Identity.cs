...
namespace Repo.Data.IdentityContext.Migrations
{
    /// <inheritdoc />
    public partial class Identity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    UserReservationName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookBorrowing", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookBorrowing_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookBorrowing_Borrowing_BorrowingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookReservation_Reservation_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookBorrowing_BookId",
                table: "BookBorrowing",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookBorrowing_BorrowingId",
                table: "BookBorrowing",
                column: "BorrowingId");
